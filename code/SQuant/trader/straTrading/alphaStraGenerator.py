...
class AlphaStraGenerator(object):
    ...
    def stock_selector(self, context, user_options=None):
        ...
        merge_series = selector_list[0]
        merge = merge_series.to_frame(name=index_list[0]+"_"+"condition")
    ...
    def stock_ranker(self, context, user_options=None):
        """
